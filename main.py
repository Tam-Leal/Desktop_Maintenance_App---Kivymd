...
class MyApp(MDApp):
    ...
    def database_login(self):
        ...
        with open("database/database.csv", "r", newline="") as f:
    ...
    def signup_register(self):
        with open("database/database.csv", "a", newline="") as file:
    ...
    def issues(self):
        with open("issues/issues.csv", "r", newline="") as file:
    ...
    def requests(self):
        with open("requests/request.csv", "a", newline="") as file:
            writer = csv.writer(file, delimiter=";")
    ...
    def queue(self):
        ...
        count = 0
        with open("requests/request.csv", "r", newline="") as file:
            reader = csv.reader(file, delimiter=";")
            for i in reader:
